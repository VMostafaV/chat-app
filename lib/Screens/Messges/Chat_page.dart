...
class ChatPage extends StatefulWidget {
  static const String ChatPageR = 'ChatPageR';
...
class _ChatPageState extends State<ChatPage> {
  ...
  void getMessege() async {
    await for (var snapshot
        in _firebasestor.collection('messeges').snapshots()) {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
                ...
                width: 500,
                decoration:
                    const BoxDecoration(color: Color.fromARGB(255, 1, 32, 73)),
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: IconButton(
                          onPressed: () {
                            _firebasestor.collection('messeges').add({
                              'text': messege,
                              'sender': signIn.email,
...
class _StreambldrState extends State<Streambldr> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firebasestor.collection('messeges').orderBy('time').snapshots(),
